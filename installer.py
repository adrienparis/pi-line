...
cmds.shelfButton(rpt=True, i1=pathPiLine + "/logo/install.png", l="Install", p="Custom", c="import sys;sys.path.append(\"" + current_path + "\");import installer; installer.install(\"" + current_path + "\")")
